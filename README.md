...
| `SigmaTau.Est`  | Clock state-space models (`TwoStateClock`, `ThreeStateClock`) and Kalman filtering for atomic-clock work. AD-friendly out-of-place math via `StaticArrays`. |
...
est   = KalmanFilter([0.0, 0.0, 0.0], 1e-12 * I(3))
