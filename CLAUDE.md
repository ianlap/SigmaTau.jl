...
The `/sync-changelog` skill drafts the move from a working diff.
...
- Kalman, Q-matrix, EDF, or filter-divergence design questions →
  ...
  reasoning end-to-end inline. It has Riley/Greenhall/IEEE-1139
  context loaded and is faster for state-estimation reviews.
